...
struct test_pmgen_pm {
  ...
  void block_0(int recursion YS_ATTRIBUTE(unused)) {
    vector<pair<Cell*, IdString>> &chain YS_ATTRIBUTE(unused) = ud_reduce.chain;
    SigSpec &leaves YS_ATTRIBUTE(unused) = ud_reduce.leaves;
    vector<pair<Cell*, IdString>> &longest_chain YS_ATTRIBUTE(unused) = ud_reduce.longest_chain;
    pool<Cell*> &non_first_cells YS_ATTRIBUTE(unused) = ud_reduce.non_first_cells;
...
rollback_label:
  ...
  void block_1(int recursion YS_ATTRIBUTE(unused)) {
    Cell* &first YS_ATTRIBUTE(unused) = st_reduce.first;
    vector<pair<Cell*, IdString>> &chain YS_ATTRIBUTE(unused) = ud_reduce.chain;
    SigSpec &leaves YS_ATTRIBUTE(unused) = ud_reduce.leaves;
    vector<pair<Cell*, IdString>> &longest_chain YS_ATTRIBUTE(unused) = ud_reduce.longest_chain;
    pool<Cell*> &non_first_cells YS_ATTRIBUTE(unused) = ud_reduce.non_first_cells;
...
#undef finish
  ...
  void block_2(int recursion YS_ATTRIBUTE(unused)) {
    Cell* const &first YS_ATTRIBUTE(unused) = st_reduce.first;
    vector<pair<Cell*, IdString>> &chain YS_ATTRIBUTE(unused) = ud_reduce.chain;
    SigSpec &leaves YS_ATTRIBUTE(unused) = ud_reduce.leaves;
    vector<pair<Cell*, IdString>> &longest_chain YS_ATTRIBUTE(unused) = ud_reduce.longest_chain;
    pool<Cell*> &non_first_cells YS_ATTRIBUTE(unused) = ud_reduce.non_first_cells;
...
#undef finish
  ...
  void block_5(int recursion YS_ATTRIBUTE(unused)) {
    Cell* const &first YS_ATTRIBUTE(unused) = st_reduce.first;
    IdString &portname YS_ATTRIBUTE(unused) = st_reduce.portname;
    vector<pair<Cell*, IdString>> &chain YS_ATTRIBUTE(unused) = ud_reduce.chain;
    SigSpec &leaves YS_ATTRIBUTE(unused) = ud_reduce.leaves;
    vector<pair<Cell*, IdString>> &longest_chain YS_ATTRIBUTE(unused) = ud_reduce.longest_chain;
    pool<Cell*> &non_first_cells YS_ATTRIBUTE(unused) = ud_reduce.non_first_cells;
...
rollback_label:
  ...
  void block_6(int recursion YS_ATTRIBUTE(unused)) {
    Cell* const &first YS_ATTRIBUTE(unused) = st_reduce.first;
    const IdString &portname YS_ATTRIBUTE(unused) = st_reduce.portname;
    Cell* &next YS_ATTRIBUTE(unused) = st_reduce.next;
    vector<pair<Cell*, IdString>> &chain YS_ATTRIBUTE(unused) = ud_reduce.chain;
    SigSpec &leaves YS_ATTRIBUTE(unused) = ud_reduce.leaves;
    vector<pair<Cell*, IdString>> &longest_chain YS_ATTRIBUTE(unused) = ud_reduce.longest_chain;
    pool<Cell*> &non_first_cells YS_ATTRIBUTE(unused) = ud_reduce.non_first_cells;
  ...
  void block_7(int recursion YS_ATTRIBUTE(unused)) {
    Cell* const &first YS_ATTRIBUTE(unused) = st_reduce.first;
    Cell* const &next YS_ATTRIBUTE(unused) = st_reduce.next;
    const IdString &portname YS_ATTRIBUTE(unused) = st_reduce.portname;
    vector<pair<Cell*, IdString>> &chain YS_ATTRIBUTE(unused) = ud_reduce.chain;
    SigSpec &leaves YS_ATTRIBUTE(unused) = ud_reduce.leaves;
    vector<pair<Cell*, IdString>> &longest_chain YS_ATTRIBUTE(unused) = ud_reduce.longest_chain;
...
#undef finish
  ...
  void block_12(int recursion YS_ATTRIBUTE(unused)) {
    Cell* &eq YS_ATTRIBUTE(unused) = st_eqpmux.eq;
    SigSpec &eq_inA YS_ATTRIBUTE(unused) = st_eqpmux.eq_inA;
    SigSpec &eq_inB YS_ATTRIBUTE(unused) = st_eqpmux.eq_inB;
    bool &eq_ne_signed YS_ATTRIBUTE(unused) = st_eqpmux.eq_ne_signed;
...
#undef finish
  ...
  void block_13(int recursion YS_ATTRIBUTE(unused)) {
    Cell* const &eq YS_ATTRIBUTE(unused) = st_eqpmux.eq;
    const SigSpec &eq_inA YS_ATTRIBUTE(unused) = st_eqpmux.eq_inA;
    const SigSpec &eq_inB YS_ATTRIBUTE(unused) = st_eqpmux.eq_inB;
    const bool &eq_ne_signed YS_ATTRIBUTE(unused) = st_eqpmux.eq_ne_signed;
    Cell* &pmux YS_ATTRIBUTE(unused) = st_eqpmux.pmux;
    int &pmux_slice_eq YS_ATTRIBUTE(unused) = st_eqpmux.pmux_slice_eq;
...
#undef finish
  ...
  void block_14(int recursion YS_ATTRIBUTE(unused)) {
    ...
    const SigSpec &eq_inB YS_ATTRIBUTE(unused) = st_eqpmux.eq_inB;
    const bool &eq_ne_signed YS_ATTRIBUTE(unused) = st_eqpmux.eq_ne_signed;
    Cell* const &pmux YS_ATTRIBUTE(unused) = st_eqpmux.pmux;
    const int &pmux_slice_eq YS_ATTRIBUTE(unused) = st_eqpmux.pmux_slice_eq;
    Cell* &ne YS_ATTRIBUTE(unused) = st_eqpmux.ne;
...
#undef finish
  ...
  void block_15(int recursion YS_ATTRIBUTE(unused)) {
    ...
    const SigSpec &eq_inB YS_ATTRIBUTE(unused) = st_eqpmux.eq_inB;
    const bool &eq_ne_signed YS_ATTRIBUTE(unused) = st_eqpmux.eq_ne_signed;
    Cell* const &ne YS_ATTRIBUTE(unused) = st_eqpmux.ne;
    Cell* const &pmux YS_ATTRIBUTE(unused) = st_eqpmux.pmux;
    const int &pmux_slice_eq YS_ATTRIBUTE(unused) = st_eqpmux.pmux_slice_eq;
    Cell* &pmux2 YS_ATTRIBUTE(unused) = st_eqpmux.pmux2;
    int &pmux_slice_ne YS_ATTRIBUTE(unused) = st_eqpmux.pmux_slice_ne;
  ...
  void block_16(int recursion YS_ATTRIBUTE(unused)) {
    ...
    Cell* const &ne YS_ATTRIBUTE(unused) = st_eqpmux.ne;
    Cell* const &pmux YS_ATTRIBUTE(unused) = st_eqpmux.pmux;
    Cell* const &pmux2 YS_ATTRIBUTE(unused) = st_eqpmux.pmux2;
    const int &pmux_slice_eq YS_ATTRIBUTE(unused) = st_eqpmux.pmux_slice_eq;
    const int &pmux_slice_ne YS_ATTRIBUTE(unused) = st_eqpmux.pmux_slice_ne;
