...
struct ice40_wrapcarry_pm {
  ...
  void block_0(int recursion YS_ATTRIBUTE(unused)) {
    Cell* &carry YS_ATTRIBUTE(unused) = st_ice40_wrapcarry.carry;
  ...
  void block_1(int recursion YS_ATTRIBUTE(unused)) {
    Cell* const &carry YS_ATTRIBUTE(unused) = st_ice40_wrapcarry.carry;
    Cell* &lut YS_ATTRIBUTE(unused) = st_ice40_wrapcarry.lut;
  ...
  void block_2(int recursion YS_ATTRIBUTE(unused)) {
    Cell* const &carry YS_ATTRIBUTE(unused) = st_ice40_wrapcarry.carry;
    Cell* const &lut YS_ATTRIBUTE(unused) = st_ice40_wrapcarry.lut;
