...
struct xilinx_srl_pm {
  ...
  void setup(const vector<Cell*> &cells) {
    ...
    for (auto cell : cells) {
      do {
        ...
        if (!(!first->type.in(id_b_FDRE) || !param(first, id_b_IS_R_INVERTED, State::S0).as_bool())) continue;
        if (!(!first->type.in(id_b_FDRE) || !param(first, id_b_IS_D_INVERTED, State::S0).as_bool())) continue;
  ...
  void block_0(int recursion YS_ATTRIBUTE(unused)) {
    vector<Cell*> &chain YS_ATTRIBUTE(unused) = ud_fixed.chain;
    vector<Cell*> &longest_chain YS_ATTRIBUTE(unused) = ud_fixed.longest_chain;
    int &minlen YS_ATTRIBUTE(unused) = ud_fixed.minlen;
    pool<Cell*> &non_first_cells YS_ATTRIBUTE(unused) = ud_fixed.non_first_cells;
...
rollback_label:
  ...
  void block_1(int recursion YS_ATTRIBUTE(unused)) {
    Cell* &first YS_ATTRIBUTE(unused) = st_fixed.first;
    vector<Cell*> &chain YS_ATTRIBUTE(unused) = ud_fixed.chain;
    vector<Cell*> &longest_chain YS_ATTRIBUTE(unused) = ud_fixed.longest_chain;
    int &minlen YS_ATTRIBUTE(unused) = ud_fixed.minlen;
    pool<Cell*> &non_first_cells YS_ATTRIBUTE(unused) = ud_fixed.non_first_cells;
...
#undef finish
  ...
  void block_2(int recursion YS_ATTRIBUTE(unused)) {
    Cell* const &first YS_ATTRIBUTE(unused) = st_fixed.first;
    IdString &clk_port YS_ATTRIBUTE(unused) = st_fixed.clk_port;
    IdString &en_port YS_ATTRIBUTE(unused) = st_fixed.en_port;
    vector<Cell*> &chain YS_ATTRIBUTE(unused) = ud_fixed.chain;
    vector<Cell*> &longest_chain YS_ATTRIBUTE(unused) = ud_fixed.longest_chain;
    int &minlen YS_ATTRIBUTE(unused) = ud_fixed.minlen;
    pool<Cell*> &non_first_cells YS_ATTRIBUTE(unused) = ud_fixed.non_first_cells;
...
#undef finish
  ...
  void block_4(int recursion YS_ATTRIBUTE(unused)) {
    const IdString &clk_port YS_ATTRIBUTE(unused) = st_fixed.clk_port;
    const IdString &en_port YS_ATTRIBUTE(unused) = st_fixed.en_port;
    Cell* &first YS_ATTRIBUTE(unused) = st_fixed.first;
    vector<Cell*> &chain YS_ATTRIBUTE(unused) = ud_fixed.chain;
    vector<Cell*> &longest_chain YS_ATTRIBUTE(unused) = ud_fixed.longest_chain;
    int &minlen YS_ATTRIBUTE(unused) = ud_fixed.minlen;
...
rollback_label:
  ...
  void block_6(int recursion YS_ATTRIBUTE(unused)) {
    ...
    const IdString &en_port YS_ATTRIBUTE(unused) = st_fixed.en_port;
    Cell* const &first YS_ATTRIBUTE(unused) = st_fixed.first;
    Cell* &next YS_ATTRIBUTE(unused) = st_fixed.next;
    vector<Cell*> &chain YS_ATTRIBUTE(unused) = ud_fixed.chain;
    vector<Cell*> &longest_chain YS_ATTRIBUTE(unused) = ud_fixed.longest_chain;
    int &minlen YS_ATTRIBUTE(unused) = ud_fixed.minlen;
    pool<Cell*> &non_first_cells YS_ATTRIBUTE(unused) = ud_fixed.non_first_cells;
    ...
    if (cells_ptr != index_6.end()) {
      ...
      for (int _pmg_idx = 0; _pmg_idx < GetSize(cells); _pmg_idx++) {
        ...
        if (!(!first->type.in(id_b_FDRE) || param(next, id_b_IS_C_INVERTED, State::S0).as_bool() == param(first, id_b_IS_C_INVERTED, State::S0).as_bool())) continue;
        if (!(!first->type.in(id_b_FDRE) || param(next, id_b_IS_D_INVERTED, State::S0).as_bool() == param(first, id_b_IS_D_INVERTED, State::S0).as_bool())) continue;
        if (!(!first->type.in(id_b_FDRE) || param(next, id_b_IS_R_INVERTED, State::S0).as_bool() == param(first, id_b_IS_R_INVERTED, State::S0).as_bool())) continue;
  ...
  void block_7(int recursion YS_ATTRIBUTE(unused)) {
    ...
    const IdString &en_port YS_ATTRIBUTE(unused) = st_fixed.en_port;
    Cell* const &first YS_ATTRIBUTE(unused) = st_fixed.first;
    Cell* const &next YS_ATTRIBUTE(unused) = st_fixed.next;
    vector<Cell*> &chain YS_ATTRIBUTE(unused) = ud_fixed.chain;
    vector<Cell*> &longest_chain YS_ATTRIBUTE(unused) = ud_fixed.longest_chain;
    int &minlen YS_ATTRIBUTE(unused) = ud_fixed.minlen;
    pool<Cell*> &non_first_cells YS_ATTRIBUTE(unused) = ud_fixed.non_first_cells;
...
#undef finish
  ...
  void block_12(int recursion YS_ATTRIBUTE(unused)) {
    vector<pair<Cell*,int>> &chain YS_ATTRIBUTE(unused) = ud_variable.chain;
    pool<SigBit> &chain_bits YS_ATTRIBUTE(unused) = ud_variable.chain_bits;
    int &minlen YS_ATTRIBUTE(unused) = ud_variable.minlen;
...
rollback_label:
  ...
  void block_13(int recursion YS_ATTRIBUTE(unused)) {
    Cell* &shiftx YS_ATTRIBUTE(unused) = st_variable.shiftx;
    vector<pair<Cell*,int>> &chain YS_ATTRIBUTE(unused) = ud_variable.chain;
    pool<SigBit> &chain_bits YS_ATTRIBUTE(unused) = ud_variable.chain_bits;
    int &minlen YS_ATTRIBUTE(unused) = ud_variable.minlen;
...
#undef finish
  ...
  void block_14(int recursion YS_ATTRIBUTE(unused)) {
    Cell* const &shiftx YS_ATTRIBUTE(unused) = st_variable.shiftx;
    int &shiftx_width YS_ATTRIBUTE(unused) = st_variable.shiftx_width;
    vector<pair<Cell*,int>> &chain YS_ATTRIBUTE(unused) = ud_variable.chain;
    pool<SigBit> &chain_bits YS_ATTRIBUTE(unused) = ud_variable.chain_bits;
    int &minlen YS_ATTRIBUTE(unused) = ud_variable.minlen;
...
rollback_label:
  ...
  void block_15(int recursion YS_ATTRIBUTE(unused)) {
    Cell* const &shiftx YS_ATTRIBUTE(unused) = st_variable.shiftx;
    const int &shiftx_width YS_ATTRIBUTE(unused) = st_variable.shiftx_width;
    Cell* &first YS_ATTRIBUTE(unused) = st_variable.first;
    int &slice YS_ATTRIBUTE(unused) = st_variable.slice;
    vector<pair<Cell*,int>> &chain YS_ATTRIBUTE(unused) = ud_variable.chain;
    pool<SigBit> &chain_bits YS_ATTRIBUTE(unused) = ud_variable.chain_bits;
    int &minlen YS_ATTRIBUTE(unused) = ud_variable.minlen;
    Cell* _pmg_backup_first = first;
    ...
    if (cells_ptr != index_15.end()) {
      ...
      for (int _pmg_idx = 0; _pmg_idx < GetSize(cells); _pmg_idx++) {
        first = std::get<0>(cells[_pmg_idx]);
        const int &idx YS_ATTRIBUTE(unused) = std::get<1>(cells[_pmg_idx]);
        if (blacklist_cells.count(first)) continue;
        found_any_match = true;
...
#undef finish
  ...
  void block_16(int recursion YS_ATTRIBUTE(unused)) {
    Cell* const &first YS_ATTRIBUTE(unused) = st_variable.first;
    Cell* const &shiftx YS_ATTRIBUTE(unused) = st_variable.shiftx;
    const int &shiftx_width YS_ATTRIBUTE(unused) = st_variable.shiftx_width;
    const int &slice YS_ATTRIBUTE(unused) = st_variable.slice;
    IdString &clk_port YS_ATTRIBUTE(unused) = st_variable.clk_port;
    IdString &en_port YS_ATTRIBUTE(unused) = st_variable.en_port;
    vector<pair<Cell*,int>> &chain YS_ATTRIBUTE(unused) = ud_variable.chain;
    pool<SigBit> &chain_bits YS_ATTRIBUTE(unused) = ud_variable.chain_bits;
    int &minlen YS_ATTRIBUTE(unused) = ud_variable.minlen;
...
#undef finish
  ...
  void block_18(int recursion YS_ATTRIBUTE(unused)) {
    const IdString &clk_port YS_ATTRIBUTE(unused) = st_variable.clk_port;
    const IdString &en_port YS_ATTRIBUTE(unused) = st_variable.en_port;
    Cell* const &first YS_ATTRIBUTE(unused) = st_variable.first;
    Cell* const &shiftx YS_ATTRIBUTE(unused) = st_variable.shiftx;
    const int &shiftx_width YS_ATTRIBUTE(unused) = st_variable.shiftx_width;
    Cell* &next YS_ATTRIBUTE(unused) = st_variable.next;
    int &slice YS_ATTRIBUTE(unused) = st_variable.slice;
    vector<pair<Cell*,int>> &chain YS_ATTRIBUTE(unused) = ud_variable.chain;
    pool<SigBit> &chain_bits YS_ATTRIBUTE(unused) = ud_variable.chain_bits;
    int &minlen YS_ATTRIBUTE(unused) = ud_variable.minlen;
...
#undef finish
  ...
  void block_19(int recursion YS_ATTRIBUTE(unused)) {
    ...
    const IdString &en_port YS_ATTRIBUTE(unused) = st_variable.en_port;
    Cell* const &first YS_ATTRIBUTE(unused) = st_variable.first;
    Cell* const &next YS_ATTRIBUTE(unused) = st_variable.next;
    Cell* const &shiftx YS_ATTRIBUTE(unused) = st_variable.shiftx;
    const int &shiftx_width YS_ATTRIBUTE(unused) = st_variable.shiftx_width;
    const int &slice YS_ATTRIBUTE(unused) = st_variable.slice;
    vector<pair<Cell*,int>> &chain YS_ATTRIBUTE(unused) = ud_variable.chain;
